...
typedef int HL_SPRITE;	// handle to a graphic
...
{
	// sprite handlers
	HL_SPRITE					( *pfnSPR_Load )			( const char *szPicName );
	int							( *pfnSPR_Frames )			( HL_SPRITE hPic );
	int							( *pfnSPR_Height )			( HL_SPRITE hPic, int frame );
	int							( *pfnSPR_Width )			( HL_SPRITE hPic, int frame );
	void						( *pfnSPR_Set )				( HL_SPRITE hPic, int r, int g, int b );
	...
	void						( *pfnSetCrosshair )		( HL_SPRITE hspr, wrect_t rc, int r, int g, int b );
...
// Added for user input processing
	...
	const struct model_s *		( *GetSpritePointer )		( HL_SPRITE HL_SPRITE );
